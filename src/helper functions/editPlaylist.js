async function editPlaylist (accessToken, trackArray, playlistId) {
    ...
    // `https://api.spotify.com/v1/playlists/${playlistId}/tracks?uris=${uriArray.join(",")}`
    const editPlaylistResponse = await fetch(`https://api.spotify.com/v1/playlists/${playlistId}/tracks`, {
        method: 'PUT',
        headers: {  
