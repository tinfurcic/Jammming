...
function SearchBar ({accessToken, accessTokenNew, setAccessTokenData}) {
    ...
    return (
            <div className={styles.searchBarContainer}>
                ...
                <div className={styles.lists}>
                        ...
                        <Playlist playlist={playlist} setPlaylist={setPlaylist} accessTokenNew={accessTokenNew} setAccessTokenData={setAccessTokenData} />                        
                </div>
